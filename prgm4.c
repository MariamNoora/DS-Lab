...
int main() 
{
    ...
    printf("1.Insert at Head  2.Insert at Tail  3.Delete from Head  4.Delete from Tail  5.Print List  6.Print List in Reverse  7.Exit\n");
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 3:
                deleteFromHead(&list);
                printf("Data deleted from head\n");
                break;
            case 4:
                deleteFromTail(&list);
                printf("Data deleted from tail\n");
                break;
            case 5:
